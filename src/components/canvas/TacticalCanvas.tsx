...
export const TacticalCanvas: React.FC<TacticalCanvasProps> = ({ stageRef }) => {
  ...
  return (
    ...
    >
      ...
      {swapTargetPlayerId && (
        <div className="absolute top-4 left-1/2 -translate-x-1/2 bg-amber-500/90 text-slate-950 font-semibold px-3 py-1 rounded-full shadow-lg text-xs pointer-events-none animate-bounce">
